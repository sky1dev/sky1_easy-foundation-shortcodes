...
// add_submenu_page('optine
    function osc_add_admin_efs_scripts() {
        ...
        wp_enqueue_script('efs_magnific_popup_js', plugins_url('/js/jquery.magnific-popup.js', __FILE__),array('jquery'));
        wp_enqueue_script('efs_main', plugins_url('/js/efs_main.js', __FILE__),array('jquery','efs_magnific_popup_js'));

    }
    add_action('admin_print_styles','efs_tinymce_button_css');
    function efs_tinymce_button_css() {
        wp_register_style('efs_tinymce_button_css', plugins_url('/styles/editor.css', __FILE__), array());
        wp_enqueue_style('efs_tinymce_button_css');
    ...
    function efs_osc_editor_enable_mce(){
        ...
        wp_enqueue_style('efs_magnific_popup_css', plugins_url('/styles/magnific-popup.css', __FILE__));
    ...
    function osc_efs_get_icons(){
        ...
        $efs_editor_opt=get_option('EFS_EDITOR_OPT','icon');
        ?>
        <script type="text/javascript">
            var icons='<?php echo $icon;  ?>';
            var efs_ajaxurl = '<?php echo admin_url('admin-ajax.php'); ?>';
            var efs_url='<?php echo EFS_PLUGIN_URL;?>';
            var efs_editor_opt='<?php echo $efs_editor_opt; ?>';
            var efs_dropdown_obj='<?php echo json_encode(efs_shortcodes()); ?>';
            var efs_dropdown_grp='<?php echo json_encode(efs_groups()); ?>';
        </script>
    <?php
    }
